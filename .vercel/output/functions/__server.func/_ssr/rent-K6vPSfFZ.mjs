...
import { C as IndianRupee, H as Bed, I as ChevronDown, M as ClipboardList, T as Headphones, W as Bath, X as House, d as ShieldCheck, f as Search, h as Phone, j as Clock, q as ArrowRight, v as Maximize, w as Heart, y as MapPin } from "../_libs/lucide-react.mjs";
import { i as properties, n as gallery_living_default } from "./properties-B_DAXTJD.mjs";
import { t as InquiryForm } from "./InquiryForm-to4HXRL6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/rent-K6vPSfFZ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function getPropertyNumericPrice(priceStr) {
	const clean = priceStr.replace(/[₹,]/g, "").trim();
	if (clean.includes("Cr")) return {
		amount: parseFloat(clean.replace("Cr.", "").trim()) * 1e7,
		isMonthly: false
	};
	if (clean.includes("Month")) return {
		amount: parseInt(clean.replace("/ Month", "").trim(), 10),
		isMonthly: true
	};
	return {
		amount: 0,
...
function RentPage() {
	...
	const sortedList = [...properties.filter((p) => p.category === "rent").filter((p) => {
		...
		if (budget) {
			...
			if (budget === "Under ₹25k") {
				if (amount >= 25e3) return false;
			} else if (budget === "₹25k - ₹50k") {
				if (amount < 25e3 || amount > 5e4) return false;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "relative overflow-hidden bg-white pt-12 pb-10 sm:py-14 lg:py-20 border-b border-border/40",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "container-x grid items-center gap-8 lg:grid-cols-[1.25fr_1fr] relative z-10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs font-semibold uppercase tracking-[0.25em] text-[#C49545] mb-2",
						children: "Find Your Perfect Rental"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
						className: "font-display text-3xl sm:text-4xl font-extrabold leading-tight text-[#0B1528] md:text-5xl lg:text-6xl",
						children: [
							"Find Your Perfect",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[#C49545]",
								children: "Rental Property"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-4 sm:mt-5 space-y-1 text-sm text-muted-foreground leading-relaxed font-medium",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Explore a wide range of rental flats, apartments" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "and furnished properties in prime locations." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: sortedList.length > 0 ? sortedList.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								...
								className: "mt-4 pt-4 border-t border-border/60 flex items-center gap-4 text-xs font-bold text-muted-foreground tracking-wide",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "flex items-center gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bed, { className: "h-4 w-4 text-[#C49545]" }),
											" ",
											p.features[0]
										]
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "flex items-center gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Maximize, { className: "h-4 w-4 text-[#C49545]" }),
											" ",
											p.features[1]
										]
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "flex items-center gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bath, { className: "h-4 w-4 text-[#C49545]" }),
											" ",
											p.features[2]
										]
									})
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "No properties match your filter criteria."
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => {
								setLocation("");
								setType("");
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[#C49545]",
									children: "Rental Shortlist?"
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-sm md:text-base text-muted-foreground leading-relaxed max-w-md",
							children: "Share your preferences and our team will send you the best matching options."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-8 grid grid-cols-4 divide-x divide-gray-200 border-t border-gray-100 py-8 text-center max-w-2xl",
							children: [
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "h-5 w-5 text-[#C49545]" }),
									title: "Quick Response",
									desc: "Immediate assistance and fast property visits."
								},
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: "h-5 w-5 text-[#C49545]" }),
									title: "Verified Properties",
									desc: "All rental homes are thoroughly verified and inspected."
								},
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClipboardList, { className: "h-5 w-5 text-[#C49545]" }),
									title: "Best Matches",
					...
					formIcon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClipboardList, { className: "h-6 w-6" })
				})]
			})
		})
	] });
