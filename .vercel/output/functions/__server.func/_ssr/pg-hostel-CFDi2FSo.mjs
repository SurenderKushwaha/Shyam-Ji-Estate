...
import { C as IndianRupee, H as Bed, I as ChevronDown, T as Headphones, U as BedDouble, X as House, Y as UtensilsCrossed, d as ShieldCheck, f as Search, h as Phone, j as Clock, q as ArrowRight, r as Users, w as Heart, y as MapPin } from "../_libs/lucide-react.mjs";
import { i as properties, t as gallery_bedroom_default } from "./properties-B_DAXTJD.mjs";
import { t as InquiryForm } from "./InquiryForm-to4HXRL6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pg-hostel-CFDi2FSo.js
...
function PgPage() {
	...
	const [pgType, setPgType] = (0, import_react.useState)("");
	const [roomType, setRoomType] = (0, import_react.useState)("");
	const [budget, setBudget] = (0, import_react.useState)("");
	const [sortBy, setSortBy] = (0, import_react.useState)("latest");
	const sortedList = [...properties.filter((p) => p.category === "pg").filter((p) => {
		...
		if (roomType) {
			if (!p.features.some((f) => f.toLowerCase() === roomType.toLowerCase())) return false;
		}
		if (budget) {
			const amount = getPropertyNumericPrice(p.price);
			if (budget === "Under ₹12k") {
				if (amount >= 12e3) return false;
			} else if (budget === "₹12k - ₹15k") {
				if (amount < 12e3 || amount > 15e3) return false;
			} else if (budget === "₹15k+") {
				if (amount < 15e3) return false;
			}
		}
		return true;
	})].sort((a, b) => {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Comfortable Stays. Great Living."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: "In Old Rajinder Nagar"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-4 sm:mt-5 space-y-1 text-sm text-muted-foreground leading-relaxed font-medium",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Well-furnished PGs & Hostels with all essential amenities." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Safe, comfortable and affordable living for students and working professionals." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-[10px] font-extrabold uppercase tracking-wider leading-none text-[#0B1528]",
										children: "Safe & Secure"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-[8px] font-medium text-muted-foreground mt-0.5",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "relative",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bed, { className: "pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#0B1528]/60" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
											value: roomType,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: ["Search PG & Hostel ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "h-4 w-4" })]
							})
						]
					})
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: sortedList.length > 0 ? sortedList.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "No PG accommodations match your filter criteria."
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => {
								setLocation("");
								setPgType("");
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Share your preferences (boys / girls, sharing, food) and we'll arrange visits the same day."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "h-5 w-5 text-[#C49545]" }),
									title: "Verified Properties",
									desc: "Every PG and hostel room is physically verified by our team."
								},
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UtensilsCrossed, { className: "h-5 w-5 text-[#C49545]" }),
									title: "Food Options",
					...
					formIcon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BedDouble, { className: "h-6 w-6" })
				})]
			})
		})
	] });
