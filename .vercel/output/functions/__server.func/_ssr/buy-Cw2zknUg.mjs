...
import { C as IndianRupee, E as Handshake, H as Bed, I as ChevronDown, T as Headphones, W as Bath, X as House, d as ShieldCheck, f as Search, h as Phone, o as Target, q as ArrowRight, r as Users, v as Maximize, w as Heart, y as MapPin } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/buy-Cw2zknUg.js
...
function BuyPage() {
	...
	const sortedList = [...properties.filter((p) => p.category === "buy").filter((p) => {
		...
		if (budget) {
			...
			if (budget === "Under ₹2.5 Cr.") {
				if (amount >= 25e6) return false;
			} else if (budget === "₹2.5 Cr. - ₹4 Cr.") {
				if (amount < 25e6 || amount > 4e7) return false;
			} else if (budget === "₹4 Cr.+") {
				if (amount < 4e7) return false;
			}
		}
		return true;
	})].sort((a, b) => {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Premium homes in prime locations." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Trusted advice. Transparent deals." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
													value: "Under ₹2.5 Cr.",
													children: "Under ₹2.5 Cr."
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
													value: "₹2.5 Cr. - ₹4 Cr.",
													children: "₹2.5 Cr. - ₹4 Cr."
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
													value: "₹4 Cr.+",
													children: "₹4 Cr.+"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: ["Search Property ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "h-4 w-4" })]
							})
						]
					})
				}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Target, { className: "h-5 w-5 text-[#C49545]" }),
									title: "Best Matches",
									desc: "Tailored property listings curated for your requirements."
								},
								{
									icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Handshake, { className: "h-5 w-5 text-[#C49545]" }),
					...
					formIcon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: "h-6 w-6" })
				})]
			})
		})
	] });
