  ...
  head: () => ({
    meta: [
      { title: "Refund & Cancellation Policy | Shyam Ji Estate" },
      {
        name: "description",
        content:
          "Refund & Cancellation Policy for Shyam Ji Estate. Read about cancellation policies, booking refunds, and brokerage fee guidelines.",
      },
          ...
          <div className="space-y-12">
            <div className="prose max-w-none">
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed mb-6 font-medium">
                This Refund & Cancellation Policy explains the terms governing cancellations,
                refunds, booking amounts, and brokerage fees for services provided by{" "}
                <strong className="text-primary">{BRAND.name}</strong> through{" "}
                <strong className="text-primary">www.shyamjiestate.com</strong>.
              </p>
              ...
              <section id="brokerage-fees" className="scroll-mt-24 space-y-4">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Brokerage is a professional service fee charged for introducing, arranging,
                  negotiating, and facilitating a property transaction between the customer and the
                  property owner.
                </p>
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Brokerage becomes payable when a property is confirmed or booked, a
                  rental/lease/sale agreement is executed, possession is taken, or the transaction
                ...
                <div className="bg-amber-50/50 border border-amber-200/50 rounded-2xl p-5 mt-4">
                  <p className="text-xs md:text-sm font-bold text-amber-900 flex items-center gap-2">
                    ...
                    Important: Once the brokerage service has been successfully provided and the
                    transaction is finalized, the brokerage fee is non-refundable.
                  </p>
                </div>
              </section>
              ...
              <section id="visit-cancellation" className="scroll-mt-24 space-y-3">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Customers may cancel or reschedule a property visit by contacting us before the
                  scheduled visit.
                </p>
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  No cancellation charges apply for property visit requests unless otherwise agreed
                  in writing.
                </p>
              </section>
              ...
              <section id="booking-amount" className="scroll-mt-24 space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-1.5 text-xs md:text-sm text-muted-foreground">
                  <li>
                    The terms of refund or adjustment will depend on the agreement between the
                    customer and the property owner.
                  </li>
                  <li>
                    Shyam Ji Estate acts only as a brokerage intermediary and is not responsible for
                    refund decisions made by the property owner unless we have expressly agreed
                    otherwise in writing.
                  </li>
                  <li>
                    Any refund processed by us, if applicable, will be subject to the terms agreed
              ...
              <section id="cancellation-customer" className="scroll-mt-24 space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-1.5 text-xs md:text-sm text-muted-foreground">
                  <li>
                    Brokerage already earned for completed brokerage services may remain payable.
                  </li>
                  <li>
                    Any refund of rent advance, security deposit, or booking amount will be governed
                    by the agreement between you and the property owner.
                  </li>
                </ul>
              </section>
              ...
              <section id="cancellation-owner" className="scroll-mt-24 space-y-3">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  If the property owner cancels a booking before execution of the rental, lease, or
                  sale agreement:
                </p>
                <ul className="list-disc pl-6 space-y-1.5 text-xs md:text-sm text-muted-foreground">
                  <li>
                    Any refund due will be handled according to the agreement between the customer
                    and the property owner.
                  </li>
                  <li>
                    Where Shyam Ji Estate has received funds on behalf of the owner, we will
                    facilitate the refund process in accordance with the applicable agreement and
              ...
              <section id="security-deposit" className="scroll-mt-24 space-y-3">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Security deposits are generally held and managed by the property owner unless
                  otherwise agreed. Refund of the security deposit is subject to:
                </p>
                <ul className="list-disc pl-6 space-y-1.5 text-xs md:text-sm text-muted-foreground">
                  <li>The rental or lease agreement.</li>
                  <li>
                    Adjustment of unpaid rent, utility charges, damages, or other lawful deductions.
                  </li>
                ...
                <p className="text-xs text-muted-foreground italic bg-gray-50 border border-border/40 rounded-xl p-3 mt-2">
                  Shyam Ji Estate is not responsible for disputes regarding the refund of security
                  deposits unless specifically agreed in writing.
                </p>
              </section>
              ...
              <section id="online-payments" className="scroll-mt-24 space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-1.5 text-xs md:text-sm text-muted-foreground">
                  ...
                  <li>
                    Any applicable refunds will be credited to the original payment method whenever
                    possible.
                  </li>
                  <li>
              ...
              <section id="exceptional-circumstances" className="scroll-mt-24 space-y-3">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Refunds may be considered where required by law or in exceptional circumstances,
                  including duplicate payments, incorrect payment amounts due to a technical error,
                  or other situations where a refund is legally required or approved by Shyam Ji
                  Estate.
                </p>
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Any approved refund will be processed within a reasonable period after
                  verification.
                </p>
              </section>
              ...
              <section id="how-to-request" className="scroll-mt-24 space-y-6">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  To request a cancellation or enquire about a refund, please contact us with your
                  booking details:
                </p>
                ...
                <div className="mt-8 bg-[#FAF8F5] border border-border/40 rounded-2xl p-6 text-center">
                  <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                    By using <strong className="text-primary">www.shyamjiestate.com</strong> and our
                    brokerage services, you acknowledge that you have read, understood, and agreed
                    to this Refund & Cancellation Policy.
                  </p>
                  <a
                    href={waLink(
                      "Hello Shyam Ji Estate, I have an enquiry regarding refunds or cancellations.",
                    )}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <section id="changes-policy" className="scroll-mt-24 space-y-3">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Shyam Ji Estate reserves the right to update or modify this Refund & Cancellation
                  Policy at any time. Any changes will be posted on this page with a revised
                  effective date.
                </p>
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                  Your continued use of our website or services after such changes constitutes your
