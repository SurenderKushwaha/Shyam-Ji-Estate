...
export const properties: Property[] = ([
  {
    ...
    description:
      "Highly premium fully furnished 2 BHK apartment located in New Rajinder Nagar. Features an elegant living space, a modern modular kitchen, and well-designed attached washrooms. Perfect for families or professionals looking for a premium lifestyle.",
  ...
  },
  {
    ...
    description:
      "Highly premium fully independent single occupancy room exclusively for girls. Comes with an attached modern washroom and an attached private balcony. Ideal for students and professionals seeking a peaceful environment.",
    gallery: [
      propSingleGirls1,
      propSingleGirls2,
      propSingleGirls3,
  ...
  },
  {
    ...
    features: ["Single Room", "Attached Washroom", "Attached Balcony"],
    description:
      "Premium single occupancy room for girls located near Aggarwal Sweets. The room comes with an attached modern washroom and an attached private balcony.",
  ...
  },
  {
    ...
    description:
      "Highly premium, newly constructed commercial hall available for rent on Pusa Road, Rajinder Nagar. Spanning 1200 sq. ft. on the second floor, this space directly faces the metro station, offering unparalleled commercial visibility and exposure. The property features dual high-speed elevators, stilt parking slots, false ceilings with LED lights, vitrified tiles, pantry provision, and washrooms. Highly suited for coaching centers, corporate offices, study libraries, gymnasiums, classrooms, or high-end clinics.",
    gallery: [
      commercialMetroFacing1,
      commercialMetroFacing2,
      commercialMetroFacing3,
      commercialMetroFacing4,
    ],
    priceBreakup: [
  ...
  },
  {
    ...
    description:
      "Highly premium commercial office space available for rent on Pusa Road, Rajinder Nagar. Spanning 1000 sq. ft. on the first floor, this property offers excellent visibility and accessibility. Fully furnished with modular glass cabin partition walls, an executive cabin space, a modular pantry area, workstations, and high-quality tile flooring with modern ceiling LED panel lighting. Perfect for corporate offices, IT startups, CA firms, coaching classes, or consulting agencies looking for a prime address.",
  ...
  },
  {
    ...
    description:
      "Premium single room for girls in a safe PG building. The rent includes food, high-speed Wi-Fi, daily cleaning, laundry, and RO water. Electricity up to 12 units is also included.",
  ...
  },
  {
    ...
    description:
      "Best PG in ORN offering double sharing accommodation with food included. Enjoy all modern facilities and 4-time meals per day in a clean, secure environment.",
