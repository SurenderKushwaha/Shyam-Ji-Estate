...
async function fetchInstagramReels() {
  if (!APIFY_TOKEN) {
    ...
    console.log("Please create a free account on Apify, get your API token, and add it to your GitHub Repository Secrets as APIFY_TOKEN.");
    return;
  }
  ...
  try {
    ...
    for (const post of videoPosts) {
      ...
      if (lowerCaption.includes("commercial") || lowerCaption.includes("office") || lowerCaption.includes("shop")) category = "Commercial";
